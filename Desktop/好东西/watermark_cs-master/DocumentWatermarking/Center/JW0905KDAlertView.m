...
@interface JW0905KDAlertView ()

@end

@implementation JW0905KDAlertView
...
+ (instancetype)JW0905showTitle:(NSString *)title message:(NSString *)message buttons:(NSArray<NSString *> *)buttons completion:(void (^)(NSUInteger, NSString *))completion {
    JW0905KDAlertView *alert = [self alertControllerWithTitle:title message:message preferredStyle:UIAlertControllerStyleAlert];
