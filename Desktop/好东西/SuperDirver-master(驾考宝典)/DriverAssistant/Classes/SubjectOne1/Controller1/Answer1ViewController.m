...
#import "Data1Manger.h"
#import "AnswerModel.h"
#import "Select1ModelView.h"
#import "SheetView.h"
#import "QuestionCollectManager.h"
#import "ShowScoreViewController.h"
#import "TestScoreModel.h"

@interface Answer1ViewController ()<SheetViewDelegate,scrollDelegate>
{
    AnswerScrollView *_answerScrollView;
    Select1ModelView * _modelView;
...
@implementation Answer1ViewController
...
- (void)creatData{
    ...
    if (_type == 1) {//章节练习
        NSArray *array = [Data1Manger getData:answer];
        ...
        _questionsArray = [NSMutableArray arrayWithArray:[Data1Manger getData:answer]];
        ...
        //读取错题
        NSArray *dataArray = [Data1Manger getData:answer];
...
- (void)creatModelView
{
    _modelView = [[Select1ModelView alloc] initWithFrame:self.view.frame andTouch:^(UIButton *btn) {
        switch (btn.tag) {
            case 401:
            {
