...
#import "TestSelect1ViewController.h"
    ...
    switch (btn.tag) {
        case 201://我的错题集
        {
            if ([QuestionCollectManager getWrongQuestion].count > 0) {
                Answer1ViewController *ctl = [[Answer1ViewController alloc] init];
                ctl.type = 7;
                ctl.myTitle = @"我的错题集";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    switch (indexPath.row) {
        case 0://章节练习
        {
            TestSelect1ViewController *ctl = [[TestSelect1ViewController alloc] init];
            ctl.type = 1;
            ctl.myTitle = @"章节练习";
            ctl.dataArr = [Data1Manger getData:chapter];
            [self.navigationController pushViewController:ctl animated:YES];
        }
            break;
        case 1://顺序练习
        ...
        case 3://专项练习
        {
            ...
            ctl.myTitle = @"专项练习";
            ctl.type = 2;
            ctl.dataArr = [Data1Manger getData:subChapter];
            [self.navigationController pushViewController:ctl animated:YES];
        }
            break;
        case 4://仿真模拟考试
