...
- (void)addNaviBar{
    UIView *naviBar = [TPCommonView6Helper createNavigationBar:@"计划客户" enableBackButton:NO];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    TPClientList6Cell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"TPClientList6Cell" forIndexPath:indexPath];
