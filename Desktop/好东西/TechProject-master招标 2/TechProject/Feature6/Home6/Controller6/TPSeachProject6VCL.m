...
@interface TPSeachProject6VCL ()<UISearchResultsUpdating, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate>
...
@implementation TPSeachProject6VCL
...
- (void)addNaviBar{
    UIView *naviBar = [TPCommonView6Helper createNavigationBar:@"搜索" enableBackButton:YES];
