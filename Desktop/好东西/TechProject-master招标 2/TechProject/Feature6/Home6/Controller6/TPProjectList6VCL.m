...
#import "TPCollection5FlowLayout.h"
#import "TPProjectDetailVCL.h"
#import "TPBarItem.h"
#import "TPProjectDataManager.h"
@interface TPProjectList6VCL ()<UICollectionViewDelegate, UICollectionViewDataSource>
@property (weak, nonatomic) IBOutlet UICollectionView *collectionView;
@property (nonatomic, strong) TPProjectListModel *model;
@end

@implementation TPProjectList6VCL
...
- (void)addNaviBar{
    UIView *naviBar = [TPCommonView6Helper createNavigationBar:self.region.name enableBackButton:YES];
