...
@interface JW0914NJKWebViewProgressView : UIView
@property (nonatomic) float progress;

@property (nonatomic) UIView *progressBarView;
@property (nonatomic) NSTimeInterval JW0914barAnimationDuration; // default 0.1
@property (nonatomic) NSTimeInterval JW0914fadeAnimationDuration; // default 0.27
@property (nonatomic) NSTimeInterval JW0914fadeOutDelay; // default 0.1

- (void)setProgress:(float)progress animated:(BOOL)animated;
@end

@implementation JW0914NJKWebViewProgressView
...
- (void)setup {
    ...
    _JW0914barAnimationDuration = 0.27f;
    _JW0914fadeAnimationDuration = 0.27f;
    _JW0914fadeOutDelay = 0.1f;
}
...
- (void)setProgress:(float)progress animated:(BOOL)animated {
    ...
    [UIView animateWithDuration:(isGrowing && animated) ? _JW0914barAnimationDuration : 0.0 delay:0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
    ...
    if (progress >= 1.0) {
        [UIView animateWithDuration:animated ? _JW0914fadeAnimationDuration : 0.0 delay:_JW0914fadeOutDelay options:UIViewAnimationOptionCurveEaseInOut animations:^{
        ...
        [UIView animateWithDuration:animated ? _JW0914fadeAnimationDuration : 0.0 delay:0.0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
...
@interface JW0914BaseWebController ()
...
@property (nonatomic, strong) JW0914NJKWebViewProgressView *progressView;
...
@end
@implementation JW0914BaseWebController
+ (instancetype)jw0704JW0914KDManager:(NSString *)urlString {
    return [self jw0704JW0914KDManager:urlString shareTitle:nil shareUrl:nil];
}
+ (instancetype)jw0704JW0914KDManager:(NSString *)urlString shareTitle:(NSString *)shareTitle shareUrl:(NSString *)shareUrl {
    JW0914BaseWebController *webView = [[self alloc] init];
...
- (void)webView:(WKWebView *)webView runJavaScriptAlertPanelWithMessage:(NSString *)message initiatedByFrame:(WKFrameInfo *)frame completionHandler:(void (^)(void))completionHandler {
    [JW0914KDAlertView JW0914showTitle:nil message:message buttons:@[@"确定"] completion:^(NSUInteger index, NSString *buttonTitles) {
        completionHandler();
    }];
}
...
- (void)didClickMenu:(id)sender {
    NSLog(@"didClickMenu");
    [KDActionSheet JW0914showTitle:nil message:nil buttons:@[@"分享", @"清除缓存"] completion:^(NSUInteger index, NSString *buttonTitles) {
...
- (JW0914NJKWebViewProgressView *)progressView {
    if (!_progressView) {
        CGFloat progressBarHeight = 2.f;
        CGRect navigationBarBounds = self.navigationController.navigationBar.bounds;
        CGRect barFrame = CGRectMake(0, navigationBarBounds.size.height - progressBarHeight, navigationBarBounds.size.width, progressBarHeight);
        _progressView = [[JW0914NJKWebViewProgressView alloc] initWithFrame:barFrame];
