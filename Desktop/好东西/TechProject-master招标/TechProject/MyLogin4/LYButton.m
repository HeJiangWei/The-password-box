...
-(void)clickBtn{
    ...
    // 1.弹框提醒
    // 初始化对话框
//    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"提示" message:@"账号密码不能少于5位数" preferredStyle:UIAlertControllerStyleAlert];
//    [alert addAction:[UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleDefault handler:nil]];
//    // 弹出对话框
//    [self.superVC presentViewController:alert animated:true completion:nil];
