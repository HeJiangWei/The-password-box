...
@interface JCPageContoller () <UIScrollViewDelegate, JCPageSlide4BarDelegate>

@property (nonatomic, strong) JCPageSlide4Bar *slideBar;
...
- (JCPageSlide4Bar *)slideBar{
    if (!_slideBar) {
        _slideBar = [[JCPageSlide4Bar alloc]initWithFrame:CGRectMake(0, 0, self.width, 40)];
...
#pragma mark
#pragma mark -- JCPageSlide4BarDelegate 点击SlideBar 来切换页面
