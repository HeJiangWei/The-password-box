...
#import "JCPageSlide4Bar.h"
#import "JCPageSlide4BarCell.h"
#import <YYCategories.h>
@interface JCPageSlide4Bar() <UICollectionViewDelegate, UICollectionViewDelegateFlowLayout,UICollectionViewDataSource>
@property (nonatomic, strong) UICollectionView *collectionView;
@property (nonatomic, strong) UIView *line;//底部横线
@property (nonatomic, assign) NSInteger curSelectIndex;
@end

@implementation JCPageSlide4Bar
...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[JCPageSlide4BarCell class] forCellWithReuseIdentifier:@"JCPageSlide4BarCell"];
        [self addSubview:_collectionView];
        
        CALayer *line = [CALayer layer];
        line.backgroundColor = [UIColor colorWithHexString:@"d4d4d4"].CGColor;
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    JCPageSlide4BarCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"JCPageSlide4BarCell" forIndexPath:indexPath];
    if ([self.dataSource respondsToSelector:@selector(pageContoller:titleForCellAtIndex:)]) {
