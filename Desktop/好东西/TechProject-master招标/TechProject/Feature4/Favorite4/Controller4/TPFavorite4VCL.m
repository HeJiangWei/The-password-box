...
@interface TPFavorite4VCL ()<JCPageContollerDataSource, JCPageContollerDelegate>
@property (nonatomic, strong) TPFavoriteModel *model;
@property (nonatomic, strong) JCPageContoller *pageController;
@end

@implementation TPFavorite4VCL
...
- (void)addNaviBar{
    UIView *naviBar = [TPCommonView4Helper createNavigationBar:@"收藏" enableBackButton:YES];
