...
#import "TPHome4Model.h"
#import "TPProjectListVCL.h"
#import "TPSeachProjectVCL.h"
#import "TPSnow4View.h"
#import "TPFavorite4VCL.h"
...
@property (nonatomic, strong) TPHome4Model *model;
@end
...
- (void)addNaviBar{
    UIView *naviBar = [TPCommonView4Helper createNavigationBar:@"项目" enableBackButton:NO];
...
- (void)openFavoriteVCL{
    UIStoryboard *main = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
    TPFavorite4VCL *vcl = (TPFavorite4VCL *)[main instantiateViewControllerWithIdentifier:@"TPFavorite4VCL"];
    [self.navigationController pushViewController:vcl animated:YES];
}
