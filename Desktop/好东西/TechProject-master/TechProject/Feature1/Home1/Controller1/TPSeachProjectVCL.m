...
- (void)addNaviBar{
    UIView *naviBar = [TPCommon1ViewHelper createNavigationBar:@"搜索" enableBackButton:YES];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!self.searchController.active) {
        TPProject1Model *model = _projectArr[indexPath.row];
        cell.textLabel.text = model.name;
    } else {
        TPProject1Model *model = _filterArr[indexPath.row];
        cell.textLabel.text = model.name;
    }
