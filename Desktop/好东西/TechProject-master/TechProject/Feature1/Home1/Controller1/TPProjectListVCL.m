...
- (void)addNaviBar{
    UIView *naviBar = [TPCommon1ViewHelper createNavigationBar:self.region.name enableBackButton:YES];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    TPProjectList1Cell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"TPProjectList1Cell" forIndexPath:indexPath];
