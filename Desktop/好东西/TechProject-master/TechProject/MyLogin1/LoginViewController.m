...
{
    LYTextField *username;
    LYTextField *password;
    LYButton *login;
}
...
//    detail.text = @"Don`t have an account yet? Sign Up";
    ...
    username = [[LYTextField alloc]initWithFrame:CGRectMake(0, 0, 270, 30)];
    ...
    password = [[LYTextField alloc]initWithFrame:CGRectMake(0, 0, 270, 30)];
...
-(CAGradientLayer *)backgroundLayer{
    ...
    gradientLayer.colors = @[(__bridge id)[UIColor purpleColor].CGColor,(__bridge id)[UIColor blueColor].CGColor];
