...
- (NSArray <TPProject1Model *> *)fetchProjectDataFromDB{
...
- (NSArray <TPClient1Model *> *)fetchClientDataFromDB{
...
- (void)saveClientData:(TPClient1Model *)client{
    NSMutableArray *arr = [NSMutableArray arrayWithArray:_clientArr];
    NSInteger i = 0;
    for (TPClient1Model *model in _clientArr) {
