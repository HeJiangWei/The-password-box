...
@property (nonatomic) Dekojw0815FlowLayout *layout;
...
- (void)_dismissWithItemAtIndexPath:(NSIndexPath *)indexPath
{
	...
	{
		Dekojw0815GalleryItemView *itemView = [self _itemViewForIndexPath:indexPath];
		itemView.loading = NO;
	}
...
- (Dekojw0815GalleryItemView *)_itemViewInCell:(UICollectionViewCell *)cell
{
	Dekojw0815GalleryItemView *itemView = nil;
	
	for (UIView *subview in cell.contentView.subviews)
	{
		if ([subview isKindOfClass:[Dekojw0815GalleryItemView class]])
		{
			itemView = (Dekojw0815GalleryItemView *)subview;
		}
	}
...
- (Dekojw0815GalleryItemView *)_itemViewForIndexPath:(NSIndexPath *)indexPath
{
...
- (void)viewDidLoad
{
	...
	self.layout = [[Dekojw0815FlowLayout alloc] init];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
	...
	Dekojw0815GalleryItemView *itemView = [self _itemViewInCell:cell];

	if (itemView == nil)
	{
		itemView = [[Dekojw0815GalleryItemView alloc] initWithFrame:cell.bounds];
	}
