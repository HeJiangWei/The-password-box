...
#import "Dekojw0815CircleMenuView.h"
#import "DekoLocalizationManager.h"
#import "Dekojw0815Functions.h"
...
@interface DekoMenuView () <Dekojw0815MenuButtonDelegate>
@property (nonatomic) UIView *baseContainer;
@property (nonatomic) UIView *shareContainer;
@property (nonatomic) Dekojw0815MenuButton *plusButton;
@property (nonatomic) Dekojw0815MenuButton *galleryButton;
@property (nonatomic) Dekojw0815MenuButton *shareButton;
@property (nonatomic) Dekojw0815MenuButton *twitterButton;
@property (nonatomic) Dekojw0815MenuButton *facebookButton;
@property (nonatomic) Dekojw0815MenuButton *emailButton;
@property (nonatomic) Dekojw0815MenuButton *photosButton;
@property (nonatomic) Dekojw0815MenuButton *imageCopyButton;
...
@property (nonatomic) Dekojw0815CircleMenuView *baseMenuCircles;
@property (nonatomic) Dekojw0815CircleMenuView *shareMenuCircles;
@end
...
- (void)_populateMenuWithProStatus:(BOOL)proPurchased tutorial:(BOOL)tutorial
{
	...
	Dekojw0815CircleMenuView *baseCircles = [[Dekojw0815CircleMenuView alloc] initWithFrame:self.baseContainer.bounds];
	...
	Dekojw0815CircleMenuView *shareCircles = [[Dekojw0815CircleMenuView alloc] initWithFrame:AECGRectPlaceY(self.shareContainer.bounds, self.shareContainer.bounds.origin.y + landscapeOffset)];
	...
	Dekojw0815MenuButton *galleryButton = [Dekojw0815MenuButton buttonWithType:UIButtonTypeCustom];
	...
	Dekojw0815MenuButton *plusButton = [Dekojw0815MenuButton buttonWithType:UIButtonTypeCustom];
	...
	Dekojw0815MenuButton *shareButton = [Dekojw0815MenuButton buttonWithType:UIButtonTypeCustom];
	...
	Dekojw0815MenuButton *backButton = [Dekojw0815MenuButton buttonWithType:UIButtonTypeCustom];
	...
	Dekojw0815MenuButton *twitterButton = [Dekojw0815MenuButton buttonWithType:UIButtonTypeCustom];
	...
	Dekojw0815MenuButton *facebookButton = [Dekojw0815MenuButton buttonWithType:UIButtonTypeCustom];
	...
	Dekojw0815MenuButton *emailButton = [Dekojw0815MenuButton buttonWithType:UIButtonTypeCustom];
	...
	Dekojw0815MenuButton *photosButton = [Dekojw0815MenuButton buttonWithType:UIButtonTypeCustom];
	...
	Dekojw0815MenuButton *copyButton = [Dekojw0815MenuButton buttonWithType:UIButtonTypeCustom];
	...
	if (!proPurchased)
	{
		Dekojw0815MenuButton *unlockHighQualityButton = [Dekojw0815MenuButton buttonWithType:UIButtonTypeCustom];
...
#pragma mark - Dekojw0815MenuButtonDelegate
