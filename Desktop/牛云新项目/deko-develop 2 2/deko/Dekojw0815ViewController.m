...
#import "DekoScene.h"
#import "Dekojw0815CreditsViewController.h"
#import "DekoConstants.h"
#import "DekoIAPViewController.h"
#import "Dekojw0815TutorialHelper.h"
...
@interface Dekojw0815ViewController () <DekoMenuViewDelegate, Dekojw0815ShareHelperDelegate, MFMailComposeViewControllerDelegate, DekoGalleryViewControllerDelegate, DekoIAPViewControllerDelegate>
@property (nonatomic) Dekojw0815LogoView *logoView;
...
@property (nonatomic) Dekojw0815TutorialHelper *tutorialHelper;
...
@property (nonatomic) Dekojw0815HapticFeedbackController *hapticFeedbackController;
@property (nonatomic) NSInteger previousStep;
@end

@implementation Dekojw0815ViewController
...
{
	Dekojw0815CreditsViewController *creditsViewController = [[Dekojw0815CreditsViewController alloc] initWithNibName:nil bundle:nil];
...
- (void)_configureViews
{
	...
	self.logoView = [[Dekojw0815LogoView alloc] initWithFrame:self.view.bounds];
...
- (void)viewDidLoad
{
	...
	self.tutorialHelper = [[Dekojw0815TutorialHelper alloc] init];
    ...
    self.hapticFeedbackController = [[Dekojw0815HapticFeedbackController alloc] init];
...
#pragma mark - Dekojw0815ShareHelperDelegate
