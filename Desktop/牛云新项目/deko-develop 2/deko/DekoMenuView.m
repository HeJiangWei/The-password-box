...
#import "Dekojw0803CircleMenuView.h"
#import "DekoLocalizationManager.h"
#import "Dekojw0803Functions.h"
...
@interface DekoMenuView () <Dekojw0803MenuButtonDelegate>
@property (nonatomic) UIView *baseContainer;
@property (nonatomic) UIView *shareContainer;
@property (nonatomic) Dekojw0803MenuButton *plusButton;
@property (nonatomic) Dekojw0803MenuButton *galleryButton;
@property (nonatomic) Dekojw0803MenuButton *shareButton;
@property (nonatomic) Dekojw0803MenuButton *twitterButton;
@property (nonatomic) Dekojw0803MenuButton *facebookButton;
@property (nonatomic) Dekojw0803MenuButton *emailButton;
@property (nonatomic) Dekojw0803MenuButton *photosButton;
@property (nonatomic) Dekojw0803MenuButton *imageCopyButton;
...
@property (nonatomic) Dekojw0803CircleMenuView *baseMenuCircles;
@property (nonatomic) Dekojw0803CircleMenuView *shareMenuCircles;
@end
...
- (void)_populateMenuWithProStatus:(BOOL)proPurchased tutorial:(BOOL)tutorial
{
	...
	Dekojw0803CircleMenuView *baseCircles = [[Dekojw0803CircleMenuView alloc] initWithFrame:self.baseContainer.bounds];
	...
	Dekojw0803CircleMenuView *shareCircles = [[Dekojw0803CircleMenuView alloc] initWithFrame:AECGRectPlaceY(self.shareContainer.bounds, self.shareContainer.bounds.origin.y + landscapeOffset)];
	...
	Dekojw0803MenuButton *galleryButton = [Dekojw0803MenuButton buttonWithType:UIButtonTypeCustom];
	...
	Dekojw0803MenuButton *plusButton = [Dekojw0803MenuButton buttonWithType:UIButtonTypeCustom];
	...
	Dekojw0803MenuButton *shareButton = [Dekojw0803MenuButton buttonWithType:UIButtonTypeCustom];
	...
	Dekojw0803MenuButton *backButton = [Dekojw0803MenuButton buttonWithType:UIButtonTypeCustom];
	...
	Dekojw0803MenuButton *twitterButton = [Dekojw0803MenuButton buttonWithType:UIButtonTypeCustom];
	...
	Dekojw0803MenuButton *facebookButton = [Dekojw0803MenuButton buttonWithType:UIButtonTypeCustom];
	...
	Dekojw0803MenuButton *emailButton = [Dekojw0803MenuButton buttonWithType:UIButtonTypeCustom];
	...
	Dekojw0803MenuButton *photosButton = [Dekojw0803MenuButton buttonWithType:UIButtonTypeCustom];
	...
	Dekojw0803MenuButton *copyButton = [Dekojw0803MenuButton buttonWithType:UIButtonTypeCustom];
	...
	if (!proPurchased)
	{
		Dekojw0803MenuButton *unlockHighQualityButton = [Dekojw0803MenuButton buttonWithType:UIButtonTypeCustom];
...
#pragma mark - Dekojw0803MenuButtonDelegate
