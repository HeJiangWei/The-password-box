...
#import "Dekojw0803GalleryItemView.h"
...
@property (nonatomic) Dekojw0803FlowLayout *layout;
...
- (void)_dismissWithItemAtIndexPath:(NSIndexPath *)indexPath
{
	...
	{
		Dekojw0803GalleryItemView *itemView = [self _itemViewForIndexPath:indexPath];
		itemView.loading = NO;
	}
...
- (Dekojw0803GalleryItemView *)_itemViewInCell:(UICollectionViewCell *)cell
{
	Dekojw0803GalleryItemView *itemView = nil;
	
	for (UIView *subview in cell.contentView.subviews)
	{
		if ([subview isKindOfClass:[Dekojw0803GalleryItemView class]])
		{
			itemView = (Dekojw0803GalleryItemView *)subview;
		}
	}
...
- (Dekojw0803GalleryItemView *)_itemViewForIndexPath:(NSIndexPath *)indexPath
{
...
- (void)viewDidLoad
{
	...
	self.layout = [[Dekojw0803FlowLayout alloc] init];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
	...
	Dekojw0803GalleryItemView *itemView = [self _itemViewInCell:cell];

	if (itemView == nil)
	{
		itemView = [[Dekojw0803GalleryItemView alloc] initWithFrame:cell.bounds];
	}
