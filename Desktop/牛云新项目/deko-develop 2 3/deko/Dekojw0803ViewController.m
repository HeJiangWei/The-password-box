...
#import "DekoScene.h"
#import "Dekojw0803CreditsViewController.h"
#import "DekoConstants.h"
#import "DekoIAPViewController.h"
#import "Dekojw0803TutorialHelper.h"
...
@interface Dekojw0803ViewController () <DekoMenuViewDelegate, Dekojw0803ShareHelperDelegate, MFMailComposeViewControllerDelegate, DekoGalleryViewControllerDelegate, DekoIAPViewControllerDelegate>
@property (nonatomic) Dekojw0803LogoView *logoView;
...
@property (nonatomic) Dekojw0803TutorialHelper *tutorialHelper;
...
@property (nonatomic) Dekojw0803HapticFeedbackController *hapticFeedbackController;
@property (nonatomic) NSInteger previousStep;
@end

@implementation Dekojw0803ViewController
...
{
	Dekojw0803CreditsViewController *creditsViewController = [[Dekojw0803CreditsViewController alloc] initWithNibName:nil bundle:nil];
...
- (void)_configureViews
{
	...
	self.logoView = [[Dekojw0803LogoView alloc] initWithFrame:self.view.bounds];
...
- (void)viewDidLoad
{
	...
	self.tutorialHelper = [[Dekojw0803TutorialHelper alloc] init];
    ...
    self.hapticFeedbackController = [[Dekojw0803HapticFeedbackController alloc] init];
...
#pragma mark - Dekojw0803ShareHelperDelegate
