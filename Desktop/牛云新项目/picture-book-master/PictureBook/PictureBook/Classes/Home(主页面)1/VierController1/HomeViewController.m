...
- (void)setUp{
    ...
    [cvc1 getBookWith:@"1"];
    cvc1.navigationItem.title = @"宝宝学英语";
    ...
    cvc2.navigationItem.title = @"宝宝学英语";
    [cvc2 getBookWith:@"2"];
    ...
    cvc3.navigationItem.title = @"宝宝学英语";
    [cvc3 getBookWith:@"3"];
...
- (void)getAdInfo{
    ...
    [YYHttp1Tool get:@"http://app.52kb.cn:666/get_start_ad_info" params:dic success:^(id responseObj) {
...
//            }
    ...
    [YYHttp1Tool get:@"http://app.52kb.cn:666/get_shut_info" params:dic success:^(id responseObj) {
