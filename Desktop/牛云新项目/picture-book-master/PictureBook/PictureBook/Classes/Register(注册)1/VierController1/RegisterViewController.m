 ...
 */
- (void)skip{
    [USER_DEFAULT setBool:NO forKey:@"firstTime"];
...
- (void)huoqu{
    ...
    if ([self valiMobile:self.phone]) {
        ...
        [YYHttp1Tool get:@"http://app.52kb.cn:666/get_phone_code" params:dic success:^(id responseObj) {
...
//    [YYHttp1Tool get:@"http://app.52kb.cn:666/verify_phone_code" params:dic success:^(id responseObj) {
//        NSString *string = responseObj[@"msg"];
