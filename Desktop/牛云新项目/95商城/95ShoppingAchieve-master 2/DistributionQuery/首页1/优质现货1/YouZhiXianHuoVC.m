...
//    NSLog(@"到了%@",jiaoyi);
    ...
    [Enginejw0803 tejiaZhuanQuLieBiaoHangYeID:hangYeID DiQu:cityID GuanJianZi:[self stingTextCityID:_ziText] Page:page PageSize:@"10" GongQiu:jiaoyi TeJia:te success:^(NSDictionary *dic) {
        [LCProgressHUD hide];
...
-(void)shengFenData{
    ...
    [Enginejw0803 getShengJiDiQusuccess:^(NSDictionary *dic) {
        NSString * item1 =[NSString stringWithFormat:@"%@",[dic objectForKey:@"Item1"]];
        if ([item1 isEqualToString:@"1"]) {
...
-(void)getHangYeAll{
    [_shengArr removeAllObjects];
    [Enginejw0803 getHangYeChanPinFenLeisuccess:^(NSDictionary *dic) {
        NSString * item1 =[NSString stringWithFormat:@"%@",[dic objectForKey:@"Item1"]];
        if ([item1 isEqualToString:@"1"]) {
            NSArray * arr =[dic objectForKey:@"Item3"];
            for (NSDictionary * dicc in arr) {
...
-(void)shengWithCity:(CityModel*)mdd{
    [_cityArr removeAllObjects];
    [Enginejw0803 getCityWithShengCode:mdd.shengCode success:^(NSDictionary *dic) {
        NSString * item1 =[NSString stringWithFormat:@"%@",[dic objectForKey:@"Item1"]];
        if ([item1 isEqualToString:@"1"]) {
...
-(void)genJuIddGetHangYe:(HangYeModel*)md{
    ...
    [Enginejw0803 getHangYeWithID:md.HYidd success:^(NSDictionary *dic) {
        NSString * item1 =[NSString stringWithFormat:@"%@",[dic objectForKey:@"Item1"]];
        if ([item1 isEqualToString:@"1"]) {
            NSArray * arr =[dic objectForKey:@"Item3"];
            for (NSDictionary * dicc in arr) {
