...
-(void)dataShuJuPage:(NSString*)page{
    [Enginejw0803 dianPuChanPinMessageID:_messageID Cid:[NSString stringWithFormat:@"%lu",_cidd] Page:page success:^(NSDictionary *dic) {
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    return [_tableView cellHeightForIndexPath:indexPath model:_dataArray[indexPath.row]keyPath:@"model" cellClass:[JinDianChaKanCell class] contentViewWidth:[Tooljw0803Class  cellContentViewWith]];
}
