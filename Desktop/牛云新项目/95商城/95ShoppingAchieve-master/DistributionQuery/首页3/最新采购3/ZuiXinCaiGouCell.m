...
@property(nonatomic,strong)UILabel * chaKanBtn;//个人

@end
@implementation ZuiXinCaiGouCell
...
+(instancetype)cellWithTableView:(UITableView*)tableView CellID:(NSString*)cellID{
    ZuiXinCaiGouCell * cell =[tableView dequeueReusableCellWithIdentifier:cellID];
    if (!cell) {
        cell=[[ZuiXinCaiGouCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
...
-(void)CreatStar{
    ...
    _chaKanBtn.font=[UIFont systemFontOfSize:13];
    _chaKanBtn.alpha=.6;
...
-(void)CreatFrame{
    ...
    .heightIs(20);
    [_chaKanBtn setSingleLineAutoResizeWithMaxWidth:100];
