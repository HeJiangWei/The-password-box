...
-(void)shuJuJieXiDataPage:(NSString*)page HangYeID:(NSString*)hangYeID  CityId:(NSString*)cityID {
    ...
    [Enginejw0803 huoQuCaiGouListViewPage:page Cid:hangYeID DiQuCode:cityID success:^(NSDictionary *dic) {
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView==_leftTabelView) {
     ...
     return [_tableView cellHeightForIndexPath:indexPath model:_dataArray[indexPath.row]keyPath:@"model" cellClass:[ZuiXinCaiGouCell class] contentViewWidth:[Tooljw0803Class  cellContentViewWith]];;
