...
@interface Messagejw0803Cell ()


@end
@implementation Messagejw0803Cell
...
+(instancetype)cellWithTableView:(UITableView*)tableView CellID:(NSString*)cellID{
    Messagejw0803Cell * cell =[tableView dequeueReusableCellWithIdentifier:cellID];
    if (!cell) {
        cell=[[Messagejw0803Cell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
