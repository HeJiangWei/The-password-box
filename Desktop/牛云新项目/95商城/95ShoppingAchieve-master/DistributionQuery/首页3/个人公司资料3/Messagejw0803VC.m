...
#import "Messagejw0803VC.h"
#import "Messagejw0803Cell.h"
#import "CityChooseVC.h"
#import "HangYeVC.h"
@interface Messagejw0803VC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation Messagejw0803VC
...
-(void)tijiaoBtn:(UIButton*)btn{
    if (_tagg==0) {
        //个人资料
        Messagejw0803Cell * cell1 =[_tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:0 inSection:0]];
        Messagejw0803Cell * cell2 =[_tableView cellForRowAtIndexPath:[NSIndexPath indexPathForRow:1 inSection:0]];
        ...
        [Enginejw0803 XiuGaiMenZiLiaoNiCheng:cell1.textfield.text Name:cell2.textfield.text Sheng:[self stringText:_shengCode Text2:[_dataDic objectForKey:@"M_Province"]] City:[self stringText:_cityCode Text2:[_dataDic objectForKey:@"M_City"]] Xian:nil success:^(NSDictionary *dic) {
      ...
      //  NSLog(@"城市%@",_cityCode);
        [Enginejw0803 XiuGaiCompanyZiLiaoName:cell1.textfield.text Address:[self stringText:_diquText Text2:[_dataDic objectForKey:@"M_Address"]] HangYeID:[self stringText:_hangYeCode Text2:[_dataDic objectForKey:@"M_Category"]] success:^(NSDictionary *dic) {
            NSString * item1 =[NSString stringWithFormat:@"%@",[dic objectForKey:@"Item1"]];
            if ([item1 isEqualToString:@"1"]) {
                NSDictionary * item3dic =[dic objectForKey:@"Item3"];
                [self saveSomeMessageDic:item3dic];
...
-(void)saveSomeMessageDic:(NSDictionary*)dic{
    ...
    [Tooljw0803Class savePlist:saveDic name:@"Login"];
...
-(void)CreatNameArr{
    NSArray * arr1;
    NSArray * arr2;
     _dataDic =[Tooljw0803Class duquPlistWenJianPlistName:@"Login"];
    NSLog(@"有没有%@",_dataDic);
    if (_tagg==0) {
         arr1 =@[@"昵称",@"真实姓名"];
         arr2 =@[@"所在地区"];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    Messagejw0803Cell * cell =[Messagejw0803Cell cellWithTableView:tableView CellID:CellIdentifier];
