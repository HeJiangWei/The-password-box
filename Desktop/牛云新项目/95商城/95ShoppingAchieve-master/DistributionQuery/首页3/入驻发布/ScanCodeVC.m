...
- (void)viewDidLoad {
    ...
    if ([Tooljw0803Class isLogin]==NO) {
        Loginjw0803VC * vc =[Loginjw0803VC new];
        vc.tagg=2;
...
-(void)tijaioBtn{
    ...
    //铭牌照片
    NSLog(@"铭牌照片地址%@",[Tooljw0803Class isString:_mingPaiUrl]);
    //整机照片
    NSLog(@"整机照片地址%@",[Tooljw0803Class isString:_zhengJiUrl]);

    [Enginejw0803 xiuGaiChanPinMessageXiangQingTitle:cell0.textfield.text ProductName:cell1.textfield.text Count:cell2.textfield.text Type:cell3.textfield.text ExpectPrice:cell4.textfield.text ProductLocation:[self stringText:_chanDiText Text2:_model.addressName] Degree:[self stringText:_chengSeCode Text2:_model.chengseCode] Description:textViewText.text JingJiPeope:[NSString stringWithFormat:@"%@",_model.jingjiID] Image1:[Tooljw0803Class isString:_mingPaiUrl] Image2:[Tooljw0803Class isString:_zhengJiUrl] MessageID:_model.messageID success:^(NSDictionary *dic) {
...
-(void)shangChuanImage:(UIImage*)image tagg:(NSInteger)tag{
   ...
   // [LCProgressHUD showLoading:@"正在上传,请稍后..."];
    //type:1.产品 2新闻 3.用户
    [Enginejw0803 ShangChuanImageData:imgData Type:@"1" success:^(NSDictionary *dic) {
        NSString * item1 =[NSString stringWithFormat:@"%@",[dic objectForKey:@"Item1"]];
        if ([item1 isEqualToString:@"1"]) {
...
-(void)fabu{
    ...
    NSLog(@"详细信息%@",textViewText.text);
    //成色
    NSLog(@"成色%@",[Tooljw0803Class isString:_chengSeText]);
    //产地
    NSLog(@"产地%@",[Tooljw0803Class isString:_chanDiText]);
    //铭牌照片
    NSLog(@"铭牌照片地址%@",[Tooljw0803Class isString:_mingPaiUrl]);
    //整机照片
    NSLog(@"整机照片地址%@",[Tooljw0803Class isString:_zhengJiUrl]);
    NSMutableDictionary * dataDic =[NSMutableDictionary new];
      ...
      [dataDic setObject:[Tooljw0803Class isString:_chanDiText] forKey:@"产地"];
     [dataDic setObject:textViewText.text forKey:@"描述"];
      [dataDic setObject:[Tooljw0803Class isString:_chengSeCode] forKey:@"成色"];
      [dataDic setObject:[Tooljw0803Class isString:_mingPaiUrl] forKey:@"铭牌照片"];
      [dataDic setObject:[Tooljw0803Class isString:_zhengJiUrl] forKey:@"整机照片"];
     [Tooljw0803Class savePlist:dataDic name:@"入驻发布"];
    
    NSDictionary * dicc =[Tooljw0803Class duquPlistWenJianPlistName:@"入驻发布"];
    if (dicc) {
