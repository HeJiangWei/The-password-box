...
#import "Registjw0803VC.h"
#import "ForGetPwdjw0803VC.h"
@interface Loginjw0803VC ()
...
#pragma mark --忘记密码
-(void)wangjiPwd{
    ForGetPwdjw0803VC * vc =[ForGetPwdjw0803VC new];
...
-(void)yanzhengCode:(UIButton*)sender{
    ...
    [Enginejw0803 getCodePhone:_phoneText.text typeStr:@"2" success:^(NSDictionary *dic) {
...
-(void)loginButton:(UIButton*)btn{
    [Enginejw0803 loginAccountPhoneNumber:_phoneText.text Pwd:_pwdText.text CodeStr:_codeText.text success:^(NSDictionary *dic) {
        NSString * item1 =[NSString stringWithFormat:@"%@",[dic objectForKey:@"Item1"]];
        if ([item1 isEqualToString:@"1"]) {
...
-(void)registBtn:(UIButton*)btn{
    Registjw0803VC * vc =[Registjw0803VC new];
