...
-(void)codeBtnClick:(UIButton*)sender{
    ...
    [Enginejw0803 getCodePhone:_phoneText.text typeStr:@"1" success:^(NSDictionary *dic) {
...
-(void)tijiaoBtn:(UIButton*)btn{
    ...
    [Enginejw0803 zhuCeAccountPhoneNumber:_phoneText.text Pwd:_pwdText.text CodeStr:_codeText.text success:^(NSDictionary *dic) {
        NSString * item1 =[NSString stringWithFormat:@"%@",[dic objectForKey:@"Item1"]];
        if ([item1 isEqualToString:@"1"]) {
