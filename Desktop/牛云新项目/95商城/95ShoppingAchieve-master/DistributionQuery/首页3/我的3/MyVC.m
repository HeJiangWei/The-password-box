...
#import "GuanYu95VC.h"
#import "XiaoXiTongZhijw0803VC.h"
...
//    NSArray * arr4 =@[@"关于95"];
    _dataArray=[[NSMutableArray alloc]initWithObjects:arr1,arr3, nil];
...
#pragma mark --获取头像
-(void)getImageHead{
    [Enginejw0803 huoQuImageWithType:@"0" success:^(NSDictionary *dic) {
...
-(UIView*)tableViewHead{
    ...
    //标题
    NSDictionary * dicc =[Tooljw0803Class duquPlistWenJianPlistName:@"Login"];
...
//    }
        ...
        if (indexPath.row==0) {
            //消息通知
            XiaoXiTongZhijw0803VC * vc =[XiaoXiTongZhijw0803VC new];
            vc.hidesBottomBarWhenPushed=YES;
            [self.navigationController pushViewController:vc animated:YES];
        }else{
            //意见反馈
