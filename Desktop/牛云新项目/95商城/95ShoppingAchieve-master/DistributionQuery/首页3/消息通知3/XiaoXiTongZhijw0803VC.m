...
#import "ShangXinjw0803VC.h"
#import "XitongTongZhijw0803VC.h"
@interface XiaoXiTongZhijw0803VC ()<SGTopTitleViewDelegate,UIScrollViewDelegate>
@property (nonatomic, strong) SGTopTitleView *topTitleView;
@property (nonatomic, strong) NSArray *titles;
@property (nonatomic, strong) UIScrollView *mainScrollView;
@end

@implementation XiaoXiTongZhijw0803VC
...
- (void)viewDidLoad {
    ...
    XitongTongZhijw0803VC *oneVC = [[XitongTongZhijw0803VC alloc] init];
...
- (void)setupChildViewController {
    ...
    //
    ShangXinjw0803VC *twoVC = [[ShangXinjw0803VC alloc] init];
