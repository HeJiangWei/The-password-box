...
@interface ShangXinjw0803VC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ShangXinjw0803VC
...
-(void)dataShuJuPage:(NSString*)page{
    [Enginejw0803 huoQuZiXunListViewCid:@"2" YeShuPage:page success:^(NSDictionary *dic) {
