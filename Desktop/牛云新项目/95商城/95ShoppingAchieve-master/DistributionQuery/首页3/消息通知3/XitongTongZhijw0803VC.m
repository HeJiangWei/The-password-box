...
#import "XitongTongZhijw0803VC.h"
#import "ShangXinjw0803Model.h"
@interface XitongTongZhijw0803VC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation XitongTongZhijw0803VC
...
-(void)dataShuJuPage:(NSString*)page{
    [Enginejw0803 huoQuZiXunListViewCid:@"1" YeShuPage:page success:^(NSDictionary *dic) {
        NSString * item1 =[NSString stringWithFormat:@"%@",[dic objectForKey:@"Item1"]];
        if ([item1 isEqualToString:@"1"]) {
            NSArray * item3 =[dic objectForKey:@"Item3"];
            NSMutableArray * array2 =[NSMutableArray new];
            for (NSDictionary *dicc in item3) {
                ShangXinjw0803Model * model =[[ShangXinjw0803Model alloc]initWithShangXinDic:dicc];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ShangXinjw0803Model * md =_dataArray[indexPath.row];
