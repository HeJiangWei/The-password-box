...
#import "CDVjw0802Plugin.h"
#import "CDVjw0802Plugin+Private.h"
#import "CDVjw0802Plugin+Resources.h"
...
NSString* const CDVjw0802PluginHandleOpenURLNotification = @"CDVjw0802PluginHandleOpenURLNotification";
NSString* const CDVjw0802PluginResetNotification = @"CDVjw0802PluginResetNotification";
...
@implementation CDVjw0802Plugin
...
- (instancetype)initWithWebViewEngine:(id <CDVWebViewEngineProtocol>)theWebViewEngine
{
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(handleOpenURL:) name:CDVjw0802PluginHandleOpenURLNotification object:nil];
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onReset) name:CDVjw0802PluginResetNotification object:theWebViewEngine.engineWebView];
