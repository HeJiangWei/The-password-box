...
extern NSString* const CDVjw0802PluginHandleOpenURLNotification;
extern NSString* const CDVjw0802PluginResetNotification;
...
@interface CDVjw0802Plugin : NSObject {}
