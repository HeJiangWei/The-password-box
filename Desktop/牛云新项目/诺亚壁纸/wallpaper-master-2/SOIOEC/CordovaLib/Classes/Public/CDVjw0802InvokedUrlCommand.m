...
@implementation CDVjw0802InvokedUrlCommand
...
+ (CDVjw0802InvokedUrlCommand*)commandFromJson:(NSArray*)jsonEntry
{
    return [[CDVjw0802InvokedUrlCommand alloc] initFromJson:jsonEntry];
}
