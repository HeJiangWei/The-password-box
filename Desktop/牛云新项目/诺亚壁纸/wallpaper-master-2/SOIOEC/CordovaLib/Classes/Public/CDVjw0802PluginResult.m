...
@interface CDVjw0802PluginResult ()

- (CDVjw0802PluginResult*)initWithStatus:(CDVCommandStatus)statusOrdinal message:(id)theMessage;

@end

@implementation CDVjw0802PluginResult
