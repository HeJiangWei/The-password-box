...
{
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(applicationLaunchedWithUrl:) name:CDVjw0802PluginHandleOpenURLNotification object:nil];
