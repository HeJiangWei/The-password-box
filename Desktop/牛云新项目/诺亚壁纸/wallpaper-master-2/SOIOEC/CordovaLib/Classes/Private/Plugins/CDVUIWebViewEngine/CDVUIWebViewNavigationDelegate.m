...
#import <Cordova/CDVjw0802CommandDelegateImpl.h>
#import <Cordova/CDVUserAgentUtil.h>
#import <objc/message.h>

@implementation CDVUIWebViewNavigationDelegate

- (instancetype)initWithEnginePlugin:(CDVjw0802Plugin*)theEnginePlugin
{
    self = [super init];
    if (self) {
...
- (void)webViewDidStartLoad:(UIWebView*)theWebView
{
    ...
    [[NSNotificationCenter defaultCenter] postNotification:[NSNotification notificationWithName:CDVjw0802PluginResetNotification object:self.enginePlugin.webView]];
}
...
- (BOOL)webView:(UIWebView*)theWebView shouldStartLoadWithRequest:(NSURLRequest*)request navigationType:(UIWebViewNavigationType)navigationType
{
    ...
    for (NSString* pluginName in vc.pluginObjects) {
        CDVjw0802Plugin* plugin = [vc.pluginObjects objectForKey:pluginName];
    ...
    if (shouldAllowNavigation) {
        ...
        [[NSNotificationCenter defaultCenter] postNotification:[NSNotification notificationWithName:CDVjw0802PluginHandleOpenURLNotification object:url]];
    }
